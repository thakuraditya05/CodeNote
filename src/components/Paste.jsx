...
import "./Paste.css"; // CSS file import karein
...
return (
    <div className="paste-container">
      <div className="paste-content-wrapper">
        ...
        {/* All Pastes */}
        <div className="pastes-list-main">
          <h2 className="list-heading">All Pastes</h2>
          
          <div className="pastes-items-container">
            {filteredPastes.length > 0 ? (
              filteredPastes.map((paste) => (
                <div key={paste?._id} className="paste-card">
                  ...
                  <div className="paste-info">
                    ...
                    <p className="paste-description">{paste?.content}</p>
                  </div>
                  ...
                  <div className="paste-actions">
                    <div className="button-group">
                      ...
                      <button className="action-btn btn-delete" onClick={() => handleDelete(paste?._id)}>
                        <Trash2 size={20} />
                      </button>
